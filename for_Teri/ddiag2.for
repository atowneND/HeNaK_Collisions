...
*     modified version 6-28-2005 removes calls to local aph routines
...
c     controlled by the parameter MAXSIZE, defined below.
      ...
      parameter    (MAXSIZE=800)              ! sets maximum size of matrix
      ...
      IF (n.gt.nd .or. nvec.gt.nd .or. n.le.0 .or. nvec.lt.0) THEN
         ddiag = -1
         stop 'ddiag2: bad input'
      ELSE IF (n.gt.MAXSIZE) THEN
         ddiag = -1
         stop 'matrix too large for array size'
      ELSE IF (n.le.8) THEN
         ierr = djacobi(A,n,nd,nvec,U,E)
         ddiag = ierr
      ELSE ! (n.gt.8 .and. n.le.MAXSIZE)
